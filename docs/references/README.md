...
This directory contains reference materials to support development of the SocialChoiceLab project.
PDF files are stored locally but **not tracked in Git** to keep the repository lightweight.
