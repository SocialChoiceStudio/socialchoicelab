...
# --------------------------------------------------------------------------
# Three-candidate race: hunter vs hunter vs aggregator
# --------------------------------------------------------------------------
...
# Browser
# htmlwidgets::saveWidget(w_canvas, "/tmp/competition_2D_demo_3Cand_r.html", selfcontained = TRUE)
# browseURL("/tmp/competition_2D_demo_3Cand_r.html")
