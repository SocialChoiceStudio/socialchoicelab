...
- [`ic_interval_1d()`](https://socialchoicestudio.github.io/socialchoicelab/r/reference/ic_interval_1d.md)
...
- [`ic_polygon_2d()`](https://socialchoicestudio.github.io/socialchoicelab/r/reference/ic_polygon_2d.md)
...
Interactive **canvas** htmlwidgets for spatial voting analysis. Compose
layers by passing the figure payload from one function into the next.
...
- [`layer_convex_hull()`](https://socialchoicestudio.github.io/socialchoicelab/r/reference/layer_convex_hull.md)
  : Add a Pareto set layer (convex hull of ideals under Euclidean
  preferences)
