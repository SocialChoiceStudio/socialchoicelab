"""competition_2D_demo_3Cand.py — Three-candidate Hunter competition demo
=========================================================================

Parallel to r/competition_2D_demo_3Cand.R. Generates voters from a Gaussian
distribution, runs a hunter-vs-hunter-vs-aggregator race with three candidates,
and opens the canvas animation.

Run from the project root:
  export SCS_LIB_PATH=$(pwd)/build
  python python/competition_2D_demo_3Cand.py
"""
...
# ---------------------------------------------------------------------------
# Competition — hunter vs hunter vs aggregator (3 candidates)
# ---------------------------------------------------------------------------
...
with scl.competition_run(
    ...
    canvas_path = "/tmp/competition_2D_demo_3Cand_py.html"
