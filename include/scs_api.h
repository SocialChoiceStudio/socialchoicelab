...
// ---------------------------------------------------------------------------
// Competition opaque handles and config  (C8.x)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Competition engine / trace / experiment  (C8.x)
// ---------------------------------------------------------------------------

SCS_API SCS_CompetitionTrace* scs_competition_run(
...
SCS_API void scs_competition_trace_destroy(SCS_CompetitionTrace* trace);

SCS_API int scs_competition_trace_dims(const SCS_CompetitionTrace* trace,
                                       int* out_n_rounds,
                                       int* out_n_competitors, int* out_n_dims,
                                       char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_termination(
    const SCS_CompetitionTrace* trace, int* out_terminated_early,
    SCS_CompetitionTerminationReason* out_reason, char* err_buf,
    int err_buf_len);

SCS_API int scs_competition_trace_round_positions(
    const SCS_CompetitionTrace* trace, int round_index, double* out_positions,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_final_positions(
    const SCS_CompetitionTrace* trace, double* out_positions, int out_len,
    char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_round_vote_shares(
    const SCS_CompetitionTrace* trace, int round_index, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_round_seat_shares(
    const SCS_CompetitionTrace* trace, int round_index, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_round_vote_totals(
    const SCS_CompetitionTrace* trace, int round_index, int* out_totals,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_round_seat_totals(
    const SCS_CompetitionTrace* trace, int round_index, int* out_totals,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_trace_final_vote_shares(
...
SCS_API void scs_competition_experiment_destroy(
    SCS_CompetitionExperiment* experiment);

SCS_API int scs_competition_experiment_dims(
...
SCS_API int scs_competition_experiment_summary(
...
SCS_API int scs_competition_experiment_mean_final_vote_shares(
    const SCS_CompetitionExperiment* experiment, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_mean_final_seat_shares(
    const SCS_CompetitionExperiment* experiment, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_run_round_counts(
    const SCS_CompetitionExperiment* experiment, int* out_round_counts,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_run_termination_reasons(
    const SCS_CompetitionExperiment* experiment,
    SCS_CompetitionTerminationReason* out_reasons, int out_len, char* err_buf,
    int err_buf_len);

SCS_API int scs_competition_experiment_run_terminated_early_flags(
    const SCS_CompetitionExperiment* experiment, int* out_flags, int out_len,
    char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_run_final_vote_shares(
    const SCS_CompetitionExperiment* experiment, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_run_final_seat_shares(
    const SCS_CompetitionExperiment* experiment, double* out_shares,
    int out_len, char* err_buf, int err_buf_len);

SCS_API int scs_competition_experiment_run_final_positions(
